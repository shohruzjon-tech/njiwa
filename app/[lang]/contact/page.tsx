...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...Object.fromEntries(
          otherLocales.map((l) => [l, `${baseUrl}/${l}/contact`]),
        ),
      ...
      <section className="border-t border-white/[0.06] px-6 pb-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="overflow-hidden rounded-3xl ring-1 ring-white/[0.06] shadow-2xl">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3907.5401079040316!2d27.486731!3d-11.656084!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTHCsDM5JzIxLjkiUyAyN8KwMjknMTIuMiJF!5e0!3m2!1sen!2s!4v1774610342436!5m2!1sen!2s"
              width="100%"
              height="480"
